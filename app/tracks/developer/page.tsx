...
const TRACK_CSS = `
  ...
  .t-tag { display: inline-flex; align-items: center; gap: 10px; font-family: "Space Mono"; font-size: 12px; letter-spacing: 0.08em; text-transform: uppercase; background: var(--clay); color: var(--ink); padding: 8px 16px; border-radius: 999px; font-weight: 700; }
  ...
  .specs .s-row .v.accent { color: var(--clay); }
  ...
  .mod .m-left .m-no { font-family: "Space Mono"; font-size: 12px; color: var(--clay-deep); letter-spacing: 0.06em; }
  ...
  .out .ic { width: 40px; height: 40px; flex: none; border-radius: 11px; background: var(--clay); color: var(--ink); display: grid; place-items: center; font-family: "Bricolage Grotesque"; font-weight: 800; }
  ...
  .panel.cap { background: var(--clay); color: var(--cream); position: relative; overflow: hidden; }
  ...
  .panel.prq .kick { color: var(--clay-deep); }
  ...
  .panel.prq .runway-link { color: var(--clay-deep); }
  .t-final { background: var(--clay); color: var(--ink); text-align: center; }
  ...
  .t-final p { font-size: 18px; margin-top: 20px; color: var(--ink); max-width: 520px; margin-inline: auto; }
