...
const TRACK_CSS = `
  ...
  .t-tag { display: inline-flex; align-items: center; gap: 10px; font-family: "Space Mono"; font-size: 12px; letter-spacing: 0.08em; text-transform: uppercase; background: var(--forest); color: var(--cream); padding: 8px 16px; border-radius: 999px; font-weight: 700; }
  ...
  .specs .s-row .v.accent { color: var(--forest); }
  ...
  .mod .m-left .m-no { font-family: "Space Mono"; font-size: 12px; color: var(--forest-deep); letter-spacing: 0.06em; }
  ...
  .out .ic { width: 40px; height: 40px; flex: none; border-radius: 11px; background: var(--forest); color: var(--cream); display: grid; place-items: center; font-family: "Bricolage Grotesque"; font-weight: 800; }
  ...
  .panel.cap { background: var(--forest); color: var(--cream); }
  ...
  .panel.prq .kick { color: var(--forest-deep); }
  ...
  .panel.prq .runway-link { color: var(--forest-deep); }
  .t-final { background: var(--forest); color: var(--cream); text-align: center; }
  ...
  .t-final p { font-size: 18px; margin-top: 20px; color: color-mix(in srgb, var(--forest) 15%, var(--cream)); max-width: 520px; margin-inline: auto; }
